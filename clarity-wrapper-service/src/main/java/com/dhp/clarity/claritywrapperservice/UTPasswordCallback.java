...
/**
 */
@PropertySource(value = { "classpath:props/prod.properties" })
public class UTPasswordCallback implements CallbackHandler {
	...
	public UTPasswordCallback() {
		...
		try {
		    ...
		    properties.load(UTPasswordCallback.class.getClassLoader().getResourceAsStream("props/" + enviroment + ".properties"));
