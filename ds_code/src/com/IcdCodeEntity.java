...
@IdClass(IcdCodeEntityPK.class)
public class IcdCodeEntity {
    ...
    @Basic
    @Column(name = "ICD_CD_WITHOUT_DECIMAL", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "CHANGE_EFF_DT", nullable = false)
    ...
    @Basic
    @Column(name = "VALIDITY_IND", nullable = false, length = 1)
    ...
    public boolean equals(Object o) {
        ...
        return processFileSk == that.processFileSk &&
                ...
                Objects.equals(validityInd, that.validityInd) &&
